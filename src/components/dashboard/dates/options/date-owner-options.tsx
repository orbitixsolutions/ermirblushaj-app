...
const DateOwnerOptions = () => {
  ...
  return (
    ...
    <Card className='w-full xl:w-[325px] border-2 border-custom-red bg-custom-darkblue text-custom-white'>
      <CardHeader>
        <h3 className='mx-auto text-2xl xl:text-4xl font-bold'>Delete Groups</h3>
      </CardHeader>
      <CardBody>
    ...
    <Card className='w-full xl:w-[325px] border-2 border-custom-red bg-custom-darkblue text-custom-white'>
      <CardHeader>
        <h3 className='mx-auto text-2xl xl:text-4xl font-bold'>Delete Matches</h3>
      </CardHeader>
      <CardBody>
    ...
    <Card className='w-full xl:w-[325px] border-2 border-custom-red bg-custom-darkblue text-custom-white'>
      <CardHeader>
        <h3 className='mx-auto text-2xl xl:text-4xl font-bold'>Reset Stats</h3>
      </CardHeader>
      <CardBody>
