...
import ButtonDeleteImageTribute from '@/components/gallery/buttons/tribute/button-delete-image-tribute'
import ButtonEditImageTribute from '@/components/gallery/buttons/tribute/button-edit-image-tribute'
